...
export class FriendshipService {
  ...
  constructor(private http: HttpClient) {
    this.socket = io('http://10.13.7.3:3000/friendshipSock', {
  ...
  friendStatus(id: string) {
    return this.http.post('http://10.13.7.3:3000/friendship/friendStatus', { id: Number.parseInt(id) }, {
      withCredentials: true,
    });
  }
  ...
  requestsList(skip: number, take: number) {
    ...
    return this.http.get('http://10.13.7.3:3000/friendship/requestsList', {
      withCredentials: true,
      params: params
    });
  }
  ...
  blocklist(skip: number, take: number) {
    ...
    return this.http.get('http://10.13.7.3:3000/friendship/blocklist', {
      withCredentials: true,
      params: params
    });
  }
  ...
  friendList(skip: number, take: number) {
    ...
    return this.http.get('http://10.13.7.3:3000/friendship/friendList', {
      withCredentials: true,
      params: params
    });
  }
  isFriend(id: string) {
    return this.http.get('http://10.13.7.3:3000/friendship/find/' + id, { withCredentials: true, })
  }
}
